...
""",
        ...
        self.assertIn("Unsigned release: skipping source bundle Developer ID signature verification.", release_publisher)
        ...
        self.assertIn("constexpr CGFloat kWindowWidth = 720.0", preferences_controller)
        self.assertIn("constexpr CGFloat kWindowHeight = 560.0", preferences_controller)
        self.assertIn("navigationTitles", preferences_controller)
        self.assertIn('@"键盘输入", @"外观", @"词库与数据"', preferences_controller)
        self.assertIn('@"五笔输入（86 五笔）"', preferences_controller)
